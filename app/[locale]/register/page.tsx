  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn('Firestore profile sync postponed during Google sign-up:', firestoreErr);
      }
      ...
      if (isUnauthorizedDomainError(err)) {
        ...
        setError(getGoogleAuthErrorMessage(err, locale || 'bn'));
      }
    } finally {
            ...
            <div className="mt-6">
              ...
              >
                ...
                {isGoogleLoading 
                  ...
                  : (locale === 'bn' ? 'গুগল দিয়ে সাইন আপ করুন' : locale === 'ar' ? 'إنشاء حساب باستخدام جوجل' : 'Sign up with Google')}
              </button>
            </div>
