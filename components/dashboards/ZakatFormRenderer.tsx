        ...
        {!readOnly && (
          <label className="flex items-start gap-2 pt-2 border-t border-emerald-800/80 cursor-pointer">
            ...
            <span className="text-[11px] text-emerald-100 font-semibold leading-tight">
              আমি সজ্ঞানে সাক্ষ্য দিচ্ছি যে, আস-সুন্নাহ দাওয়াহ অ্যান্ড রিসার্চ ইনস্টিটিউট-কে আমার শিক্ষাবৃত্তির টাকা কোর্স ফি হিসেবে গ্রহণ করে আমার নামে জমা করার জন্য প্রতিনিধি নিযুক্ত করছি। উপর্যুক্ত সকল তথ্য সত্য ও নির্ভুল। উল্লিখিত কোনো তথ্য ভুল থাকলে তার দায় আমার, কর্তৃপক্ষের নয়।
            </span>
          </label>
        )}
      </div>
