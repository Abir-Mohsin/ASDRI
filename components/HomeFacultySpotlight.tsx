...
export function HomeFacultySpotlight({ locale }: HomeFacultySpotlightProps) {
  ...
  return (
    <section className="py-20 sm:py-28 bg-white border-t border-slate-200/80 font-sans" id="home_faculty_spotlight">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header: Clean, Centered & Prominent */}
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <Link
            href={`/${locale}/faculty`}
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-[#064e3b] hover:bg-emerald-900 text-white text-xs sm:text-sm font-bold transition-all shadow-md hover:shadow-lg cursor-pointer"
          >
            <span>{t.viewAll}</span>
